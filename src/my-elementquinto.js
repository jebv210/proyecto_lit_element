...
export class MyElementquinto extends LitElement {
 ...
 render() {
    ...
    <section class="products-list">
				<div class="product-item">
					<img class="quinto" src="https://i.pinimg.com/236x/45/eb/93/45eb9372db1c222f2495a7d5cde17a70.jpg" alt="" >
					<a href="#">Rayo 
          </a>
					</a>
          <div>
...
customElements.define('my-elementquinto', MyElementquinto);